...
/*
    ...
    */
public class PlayerCloseWindowBlocker extends PacketAdapter {
    public static Map<String, Integer> PlayerCloseWindowMap;
    ...
    public void onPacketReceiving(PacketEvent e) {
        ...
        if (Main.getInstance().getConfig().getBoolean("ServerLagAndCrashDetector.enable")) {
            if (PlayerCloseWindowBlocker.PlayerCloseWindowMap.containsKey(e.getPlayer().getName())) {
                PlayerCloseWindowBlocker.PlayerCloseWindowMap.put(e.getPlayer().getName(), PlayerCloseWindowBlocker.PlayerCloseWindowMap.get(e.getPlayer().getName()) + 1);
            } else {
