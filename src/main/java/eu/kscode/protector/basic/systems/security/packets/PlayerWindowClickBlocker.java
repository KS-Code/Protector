...
/*
    ...
    */
public class PlayerWindowClickBlocker extends PacketAdapter {
    public static Map<String, Integer> PlayerWindowClickMap;
    ...
    public void onPacketReceiving(PacketEvent e) {
        ...
        if (Main.getInstance().getConfig().getBoolean("ServerLagAndCrashDetector.enable")) {
            if (PlayerWindowClickBlocker.PlayerWindowClickMap.containsKey(e.getPlayer().getName())) {
                PlayerWindowClickBlocker.PlayerWindowClickMap.put(e.getPlayer().getName(), PlayerWindowClickBlocker.PlayerWindowClickMap.get(e.getPlayer().getName()) + 1);
            } else {
