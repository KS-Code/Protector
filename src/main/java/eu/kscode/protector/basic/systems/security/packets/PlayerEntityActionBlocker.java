...
public class PlayerEntityActionBlocker extends PacketAdapter {
    ...
    public void onPacketReceiving(PacketEvent e) {
        ...
        if (PlayerEntityActionBlocker.PlayerEntityActionMap.get(e.getPlayer().getName()) > Main.getConf().getConf().getInt("ServerLagAndCrashDetector.Blocker.EntityAction.limit")) {
            e.setCancelled(true);
